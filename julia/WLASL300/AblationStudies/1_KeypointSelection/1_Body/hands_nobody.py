...
#left and right hand keypoints each with 21 kps starting at index 0, left hand is extracted first
...
log_level = 'INFO'
work_dir = './work_dirs/julia/AblationStudies/hands_noBody_flip_128px_lr_0_01' #TODO
